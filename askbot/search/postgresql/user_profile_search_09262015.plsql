...
BEGIN
    ...
    user_query = 'SELECT p.about, username, p.real_name, email FROM accounts_user INNER JOIN askbot_userprofile AS p ON id=p.accounts_user_ptr_id WHERE id=' || user_id;
